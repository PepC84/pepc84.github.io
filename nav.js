(function () {
  ...
  const isHome=path.endsWith('index.html')||path==='', isProjects=path.endsWith('projects.html'), isCV=path.endsWith('cv.html');
  const nav = document.getElementById('site-nav');
  if (!nav) return;
  nav.innerHTML = `
    <a class="nav-logo" href="/index.html">Jose<span>.</span></a>
    <div class="nav-links">
